...
void SSAO_Initialize(Renderpass* renderpass) {
...
void SSAO_Render(Renderpass* renderpass, RenderProperties* renderProperties) {
    GBuffer* gBuffer = (GBuffer*)renderpass->internalData;
...
void SSAO_Resize(Renderpass* renderpass, u32 width, u32 height) {
    GBuffer* gBuffer = (GBuffer*)renderpass->internalData;
